                        ...
                        <div className="col-12">
                            <div className="page-title-wrap">
                                <div className="page-title-heading">
                                    <h1 className="h2">My Account<span>Profile</span></h1>
                                </div>
                            ...
                            <div className="login-register-wrap text-center main-log-regi">
                                <div className="login-register-nav ">
                                    ...
                                    <nav className="nav lr-nav text-center">
                                        <Link to={'/login'} id="nav-login-tab2" data-toggle="tab"className="active">Log In</Link>
                                        <Link to={'/signup'} id="nav-register-tab2" data-toggle="tab" >Register</Link>
                                    </nav>
                                </div>
        
                                <div className="login-register-content tab-content">
                                    <div className="tab-pane fade show active" id="login2" role="tabpanel" aria-labelledby="nav-login-tab2">
                                            ...
                                            <form onSubmit={handleSubmit}>
                                                <div className="email-input input-field">
                                                    ...
                                                    <input type="email" 
                                                        ...
                                                        className="theme-input-style" required />
                                                </div>
                                                <div>
                                                    ...
                                                    <Link to={'/forgot-password'} className="-my-9 block w-fit ml-auto hover:underline hover:text-red-500">Forget password</Link>
                                                </div>
                                                <button type="submit" className="my-20 btn btn-fill-type">LogIn</button>
                                            </form>
