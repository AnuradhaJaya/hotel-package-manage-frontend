                            ...
                            <div className="login-register-wrap text-center main-log-regi">
                                ...
                                <div className="login-register-nav flex flex-col gap-5">
                                    ...
                                    <nav className="nav lr-nav text-center">
                                        <Link to={'/login'} id="nav-login-tab2" data-toggle="tab">Log In</Link>
                                        <Link to={'/signup'} id="nav-register-tab2" data-toggle="tab" className="active">Register</Link>
                                    </nav>
                                </div>
                                ...
                                <div className="login-register-content tab-content">
                                  <div className="tab-pane fade show active" id="reg2" role="tabpanel" aria-labelledby="nav-register-tab2">
